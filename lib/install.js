...
module.exports = function() {
  ...
  gladys.device.create({device: shared.gaz_sensor_MQ2, types: shared.deviceType_mq2});

  // Create the gaz sensor MQ5 device
  gladys.device.create({device: shared.gaz_sensor_MQ5, types: shared.deviceType_mq5});

  // Create the gaz detection device
  gladys.device.create({device: shared.gaz_detection, types: shared.deviceType_gaz_detection});
