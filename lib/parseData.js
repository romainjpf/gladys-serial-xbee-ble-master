...
module.exports = function(data){
	...
	try{
		...
		if(json.sensor == shared.deviceType_gas_detection[0].identifier) {
			sails.log.info('Received data from Zigbee : Warning gas');
			gladys.deviceState.createByDeviceTypeIdentifier(
					shared.deviceType_gas_detection[0].identifier,
					shared.gas_detection.service,
					state);
		}
